...
//    UiSFMLManager();
//
//    void DrawStatsPanel(float x, float y, bool isHuman) override;
//    void DrawGameLog(float x, float y) override;
//    void DrawDecisionPanel(float x, float y) override;
//    void DrawGameOverScreen(float x, float y) override;
...
//
//    void HandleGameOverInput(const sf::Vector2i& mousePos) override;
//    void HandleNormalGameInput(const sf::Vector2i& mousePos) override;
//
//    void DrawFilenameInput(float x, float y) override;
//    void HandleFilenameInput(const sf::Event& event) override;
//
//    void SetGameReference(IGameEngine* game) override;
//
//    bool Initialize() override;
//    void ProcessEvents() override;
//    void Render() override;
//
//    void AddToLog(const std::string& message) override;
...
//
//    void DrawMagazinePanel(float x, float y) override;
//    void DrawDifficultyInfoPanel(float x, float y) override;
//
