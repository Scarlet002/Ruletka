...
//    ai(), log(), gameState
//    (
//        static_cast<IPlayer&>(human),
//        static_cast<IPlayer&>(computer),
//        static_cast<IMagazineManager&>(magazine),
//        static_cast<IGameStateManager&>(gameStateManager),
//        static_cast<IAIStrategyManager&>(ai),
//        log
//    ),
//    loader(loader), saver(saver),ui(gameState),
//    gameRunning(true), playerTurn(false), gameOver(false),
//    filename(""), autoSaveFileName("")
//{
//    asyncSaver = std::make_unique<AutoSaveManager>(saver, gameState);
//
//    if (!ui.Initialize()) {
//        std::cerr << "Blad inicjalizacji UI!" << '\n';
//        gameRunning = false;
//        return;
//    }
//
//    gameState.gameStateManager.SetDifficulty(GameConfig::defaultDifficulty);
//    ai.SetStrategy(gameState);
...
//			break;
//        default:
//			HandleDifficultyChoice(GameEnums::NORMAL);
//            break;
//        }
//    }
//    if (!ui.IsShowingDifficultyMenu() && !ui.IsRestartButtonCreated())
//    {
//        switch (choice)
//        {
//        case GameEnums::HEAL:
...
//
//	ai.ExecuteCurrentStrategy(gameState);
//
...
//    {
//        gameState.gameStateManager.SetDifficulty(difficulty);
//		ai.SetStrategy(gameState);
