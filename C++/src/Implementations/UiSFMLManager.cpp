...
//
//    Text hpText("HP: " + std::to_string(player.GetHP()) + "/" +
...
//    {
//        statsText = "Pelne: " + std::to_string(full) +
//            "   Puste: " + std::to_string(empty) +
//            "   Razem: " + std::to_string(total);
//    }
//    else
//    {
//        std::string mark = "?";
...
//    switch (gameState.gameStateManager.GetDifficulty()) {
...
//
//    std::string stats = "Gracz: " + std::to_string(gameState.human.GetHP()) + " HP | " +
//        "Komputer: " + std::to_string(gameState.computer.GetHP()) + " HP";
...
//                std::cout << "DEBUG: Kliknieto przedmiot: " << btn.actionId << std::endl;
//                if (gameRef) {
...
//            if (btn.rect.getGlobalBounds().contains(mousePos.x, mousePos.y)) {
//                std::cout << "DEBUG: Kliknieto save/load: " << btn.actionId << std::endl;
...
//            if (btn.rect.getGlobalBounds().contains(mousePos.x, mousePos.y)) {
//                std::cout << "DEBUG: Kliknieto trudnosc: " << btn.actionId << std::endl;
//                if (gameRef) {
...
//        if (btn.rect.getGlobalBounds().contains(mousePos.x, mousePos.y)) {
//            std::cout << "DEBUG: Kliknieto przycisk: " << btn.actionId << std::endl;
//
//            if (gameRef) {
...
//}
//
//void UiSFMLManager::DisplayStats(const GameState& gameState) const 
//{
//    std::cout << "Gracz: " << gameState.human.GetHP()
...
//}
//
//void UiSFMLManager::SetGameReference(IGameSFML* game)
//{
//    gameRef = game;
//}
//
